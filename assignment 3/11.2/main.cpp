...
int main(int argc, char** argv) {
    ...
    cout << "What was the production cost for the first film(Positve number only)?\n";
    cin >> A.cost;
    
    cout << "What was the revenue for the first film?\n";
    cin >> A.rev;
    ...
    cout << "What was the production cost for the second film(Positve number only)?\n";
    cin >> B.cost;
    
    cout << "What was the revenue for the second film?\n";
    cin >> B.rev;
...
void opt(Mvi *A,Mvi *B)//Simply outputs the information for each movie
{
    ...
    cout << "The total net profit or loss(-) for the movie is "  <<(*A).rev - (*A).cost << ".\n\n\n";
    ...
    cout << "The total net profit or loss(-) for the movie is "  <<(*B).rev - (*B).cost << ".\n\n\n";
}